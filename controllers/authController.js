...
const handleLogin = async (req, res) => {
    ...
    res.cookie("accessToken", accessToken, {httpOnly: true, secure: true, sameSite: 'none', partitioned: true, maxAge: 12 * 60 * 1000 });

    res.cookie('jwt', refreshToken, {httpOnly: true, secure: true, sameSite: 'none', partitioned: true, maxAge: 24 * 60 * 60 * 1000 });
